...
- Kernel v0.4 complete: 47/47 tests (10 tranches). Run: `npx tsx --test tests/*.test.ts`
...
- tests/ — ten tranches (core, money, extended, persistence, api, agent, repository, platform, portal, billing-view) + fixtures (NF-e XML)
