...
- Kernel v0.4 complete: 51/51 tests (11 tranches). Run: `npx tsx --test tests/*.test.ts`
...
- tests/ — eleven tranches (core, money, extended, persistence, api, agent, repository, platform, portal, billing-view, edge) + fixtures (NF-e XML)
