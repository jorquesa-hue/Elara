...
export interface WorldData {
  ...
  bankAccounts?: ReadonlyArray<{
    id: string; tenantId: string; code: string; name: string; kind: string; glAccount: string; entityId?: string;
  }>;
  ...
  applications?: ReadonlyArray<{
    id: string; tenantId: string; leadId?: string; unitId?: string; applicantName: string; applicantEmail?: string;
    incomeCents?: number; status: string; submittedAt: string; screening?: Record<string, unknown>;
    decidedAt?: string; decidedBy?: string; adverseActionReason?: string;
  }>;
  tours?: ReadonlyArray<{
    id: string; tenantId: string; leadId?: string; unitId?: string; prospectName: string; prospectEmail?: string;
    scheduledAt: string; status: string; agentId?: string; notes?: string; createdAt: string;
    completedAt?: string; cancelReason?: string;
  }>;
  unitTurns?: ReadonlyArray<{
    id: string; tenantId: string; unitId: string; status: string; vacatedAt: string; readyAt?: string;
    tasks: ReadonlyArray<{ key: string; label: string; done: boolean; doneAt?: string }>;
    agentId?: string; notes?: string; createdAt: string; cancelReason?: string;
  }>;
  pmSchedules?: ReadonlyArray<{
