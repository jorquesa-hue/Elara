...
export class Repositories {
  ...
  async loadWorld(): Promise<WorldData> {
    ...
    return { tenants, units, unitTypes, properties, guests, ratePlans, users, customRoles, legalEntities, parties, spaces, chargeTypes, agreements, holds, journalLines, invoices, payments, deposits, bills, apPayments, agreementParties, pricingRules, purchaseOrders, budgets, prospects, leads, applications, tours, unitTurns, integrations, connectorCommands, signatureEnvelopes, workOrders, notifications, exceptions, periodLocks, bankAccounts, actionLog } as unknown as WorldData;
  }
